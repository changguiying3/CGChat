...
@implementation CGMineHeaderCell
...
-(void)setUser:(CGUser *)user{
    ...
    if (user.avatarPath) {
        ...
        [self.avatarImageView sd_setImageWithURL:CGURL(user.avatarURL)placeholderImage:[UIImage imageNamed:DEFAULT_AVATAR_PATH]];
    }
